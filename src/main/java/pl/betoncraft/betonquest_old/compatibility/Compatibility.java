 ...
 */
package pl.betoncraft.betonquest_old.compatibility;
...
import pl.betoncraft.betonquest_old.compatibility.betonlangapi.BetonLangAPIIntegrator;
import pl.betoncraft.betonquest_old.compatibility.bountifulapi.BountifulAPIIntegrator;
import pl.betoncraft.betonquest_old.compatibility.brewery.BreweryIntegrator;
import pl.betoncraft.betonquest_old.compatibility.citizens.CitizensIntegrator;
import pl.betoncraft.betonquest_old.compatibility.denizen.DenizenIntegrator;
import pl.betoncraft.betonquest_old.compatibility.effectlib.EffectLibIntegrator;
import pl.betoncraft.betonquest_old.compatibility.heroes.HeroesIntegrator;
import pl.betoncraft.betonquest_old.compatibility.holographicdisplays.HolographicDisplaysIntegrator;
import pl.betoncraft.betonquest_old.compatibility.jobsreborn.JobsRebornIntegrator;
import pl.betoncraft.betonquest_old.compatibility.legendquest.LegendQuestIntegrator;
import pl.betoncraft.betonquest_old.compatibility.magic.MagicIntegrator;
import pl.betoncraft.betonquest_old.compatibility.mcmmo.McMMOIntegrator;
import pl.betoncraft.betonquest_old.compatibility.mythicmobs.MythicMobsIntegrator;
import pl.betoncraft.betonquest_old.compatibility.placeholderapi.PlaceholderAPIIntegrator;
import pl.betoncraft.betonquest_old.compatibility.playerpoints.PlayerPointsIntegrator;
import pl.betoncraft.betonquest_old.compatibility.protocollib.ProtocolLibIntegrator;
import pl.betoncraft.betonquest_old.compatibility.quests.QuestsIntegrator;
import pl.betoncraft.betonquest_old.compatibility.racesandclasses.RacesAndClassesIntegrator;
import pl.betoncraft.betonquest_old.compatibility.shopkeepers.ShopkeepersIntegrator;
import pl.betoncraft.betonquest_old.compatibility.skillapi.SkillAPIIntegrator;
import pl.betoncraft.betonquest_old.compatibility.skript.SkriptIntegrator;
import pl.betoncraft.betonquest_old.compatibility.vault.VaultIntegrator;
import pl.betoncraft.betonquest_old.compatibility.worldedit.WorldEditIntegrator;
import pl.betoncraft.betonquest_old.compatibility.worldguard.WorldGuardIntegrator;
