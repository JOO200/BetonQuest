 ...
 */
package pl.betoncraft.betonquest_old;
...
import pl.betoncraft.betonquest.internal.conditions.AdvancementCondition;
import pl.betoncraft.betonquest.internal.conditions.AlternativeCondition;
import pl.betoncraft.betonquest.internal.objectives.DieObjective;
import pl.betoncraft.betonquest_old.api.LoadDataEvent;
...
import pl.betoncraft.betonquest_old.conversation.ConversationColors;
import pl.betoncraft.betonquest_old.conversation.ConversationData;
import pl.betoncraft.betonquest_old.conversation.ConversationIO;
import pl.betoncraft.betonquest_old.conversation.ConversationResumer;
import pl.betoncraft.betonquest_old.conversation.CubeNPCListener;
import pl.betoncraft.betonquest_old.conversation.Interceptor;
import pl.betoncraft.betonquest_old.conversation.InventoryConvIO;
import pl.betoncraft.betonquest_old.conversation.SimpleConvIO;
import pl.betoncraft.betonquest_old.conversation.SimpleInterceptor;
import pl.betoncraft.betonquest_old.conversation.SlowTellrawConvIO;
import pl.betoncraft.betonquest_old.conversation.TellrawConvIO;
import pl.betoncraft.betonquest_old.database.Database;
import pl.betoncraft.betonquest_old.database.GlobalData;
import pl.betoncraft.betonquest_old.database.MySQL;
import pl.betoncraft.betonquest_old.database.PlayerData;
import pl.betoncraft.betonquest_old.database.SQLite;
import pl.betoncraft.betonquest_old.database.Saver;
import pl.betoncraft.betonquest_old.events.CancelEvent;
import pl.betoncraft.betonquest_old.events.ChestClearEvent;
import pl.betoncraft.betonquest_old.events.ChestGiveEvent;
import pl.betoncraft.betonquest_old.events.ChestTakeEvent;
import pl.betoncraft.betonquest_old.events.ClearEvent;
import pl.betoncraft.betonquest_old.events.CommandEvent;
import pl.betoncraft.betonquest_old.events.CompassEvent;
import pl.betoncraft.betonquest_old.events.ConversationEvent;
import pl.betoncraft.betonquest_old.events.DamageEvent;
import pl.betoncraft.betonquest_old.events.DelEffectEvent;
import pl.betoncraft.betonquest_old.events.DoorEvent;
import pl.betoncraft.betonquest_old.events.EXPEvent;
import pl.betoncraft.betonquest_old.events.EffectEvent;
import pl.betoncraft.betonquest_old.events.ExplosionEvent;
import pl.betoncraft.betonquest_old.events.FolderEvent;
import pl.betoncraft.betonquest_old.events.GiveEvent;
import pl.betoncraft.betonquest_old.events.GiveJournalEvent;
import pl.betoncraft.betonquest_old.events.GlobalPointEvent;
import pl.betoncraft.betonquest_old.events.GlobalTagEvent;
import pl.betoncraft.betonquest_old.events.IfElseEvent;
import pl.betoncraft.betonquest_old.events.JournalEvent;
import pl.betoncraft.betonquest_old.events.KillEvent;
import pl.betoncraft.betonquest_old.events.KillMobEvent;
import pl.betoncraft.betonquest_old.events.LanguageEvent;
import pl.betoncraft.betonquest_old.events.LeverEvent;
import pl.betoncraft.betonquest_old.events.LightningEvent;
import pl.betoncraft.betonquest_old.events.MessageEvent;
import pl.betoncraft.betonquest_old.events.NotifyEvent;
import pl.betoncraft.betonquest_old.events.ObjectiveEvent;
import pl.betoncraft.betonquest_old.events.OpSudoEvent;
import pl.betoncraft.betonquest_old.events.PartyEvent;
import pl.betoncraft.betonquest_old.events.PickRandomEvent;
import pl.betoncraft.betonquest_old.events.PlaysoundEvent;
import pl.betoncraft.betonquest_old.events.PointEvent;
import pl.betoncraft.betonquest_old.events.RunEvent;
import pl.betoncraft.betonquest_old.events.ScoreboardEvent;
import pl.betoncraft.betonquest_old.events.SetBlockEvent;
import pl.betoncraft.betonquest_old.events.SpawnMobEvent;
import pl.betoncraft.betonquest_old.events.SudoEvent;
import pl.betoncraft.betonquest_old.events.TagEvent;
import pl.betoncraft.betonquest_old.events.TakeEvent;
import pl.betoncraft.betonquest_old.events.TeleportEvent;
import pl.betoncraft.betonquest_old.events.TimeEvent;
import pl.betoncraft.betonquest_old.events.TitleEvent;
import pl.betoncraft.betonquest_old.events.VariableEvent;
import pl.betoncraft.betonquest_old.events.WeatherEvent;
...
import pl.betoncraft.betonquest_old.item.QuestItemHandler;
import pl.betoncraft.betonquest_old.listener.CustomDropListener;
import pl.betoncraft.betonquest_old.listener.JoinQuitListener;
import pl.betoncraft.betonquest_old.listener.MobKillListener;
import pl.betoncraft.betonquest_old.notify.ActionBarNotifyIO;
import pl.betoncraft.betonquest_old.notify.AdvancementNotifyIO;
import pl.betoncraft.betonquest_old.notify.BossBarNotifyIO;
import pl.betoncraft.betonquest_old.notify.ChatNotifyIO;
import pl.betoncraft.betonquest_old.notify.NotifyIO;
import pl.betoncraft.betonquest_old.notify.SubTitleNotifyIO;
import pl.betoncraft.betonquest_old.notify.SuppressNotifyIO;
import pl.betoncraft.betonquest_old.notify.TitleNotifyIO;
import pl.betoncraft.betonquest_old.objectives.*;
import pl.betoncraft.betonquest.utils.LogUtils;
import pl.betoncraft.betonquest_old.utils.PlayerConverter;
import pl.betoncraft.betonquest_old.utils.Updater;
import pl.betoncraft.betonquest_old.utils.Utils;
import pl.betoncraft.betonquest_old.variables.GlobalPointVariable;
import pl.betoncraft.betonquest_old.variables.ItemAmountVariable;
import pl.betoncraft.betonquest_old.variables.LocationVariable;
import pl.betoncraft.betonquest_old.variables.MathVariable;
import pl.betoncraft.betonquest_old.variables.NpcNameVariable;
import pl.betoncraft.betonquest_old.variables.ObjectivePropertyVariable;
import pl.betoncraft.betonquest_old.variables.PlayerNameVariable;
import pl.betoncraft.betonquest_old.variables.PointVariable;
import pl.betoncraft.betonquest_old.variables.VersionVariable;
...
public class BetonQuest extends JavaPlugin {
    ...
    public void onEnable() {
        ...
        registerConditions("achievement", AdvancementCondition.class);
